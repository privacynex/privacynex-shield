...
const rlMap = new Map<string, RateLimitEntry>();
...
function evictOldest(): void {
  ...
  if (!oldest.done) rlMap.delete(oldest.value);
}
 ...
 */
export function checkRateLimit(ip: string, bucket: RateLimitBucket = 'doc'): RateLimitResult {
...
export function __rateLimitSizeForTest(): number {
  return rlMap.size;
}
