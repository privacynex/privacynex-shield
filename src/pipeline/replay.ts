...
import { CHALLENGE_TTL } from '../core/crypto.ts';
...
const spentJti = new Map<string, SpentEntry>();
 ...
 */
export function markSpentOrReject(
  jti: string,
  attemptId: string,
): { replay: boolean; idempotent: boolean } {
...
export function __resetSpentForTest(): void {
  spentJti.clear();
  insertCount = 0;
}
